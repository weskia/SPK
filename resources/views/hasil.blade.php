        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h5 class="card-title"><i class="fas fa-edit"><strong>&nbsp; Hasil Perhitungan AHP </strong></i></h5>
      ...
      <div class="col-md-12">
        ...
        <div class="tab-content" id="custom-tabs-four-tabContent">
          ...
          <tr>
            ...
            <td><h5>{{$ahps->nama_mahasiswa}}</h5></td>
            <td><h5>{{$ahps->id_ipk}}</h5></td>
            <td><h5>{{$ahps->id_pendapatan}}</h5></td>
            <td><h5>{{$ahps->id_tanggungan}}</h5></td>
            <td><h5>{{$ahps->id_semester}}</h5></td>
            <td><h5>{{$ahps->id_prestasi}}</h5></td>
          </tr>
          @endforeach
          </tfoot>
          </table>
